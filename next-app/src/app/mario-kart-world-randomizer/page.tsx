...
export default function MKWRandomizerPage() {
  ...
  const kart = useKartRandomizer(24);
    ...
    <>
      ...
      >
        <Container>
          <div style={{ maxWidth: "600px" }}>
            ...
            >
              Mario Kart World Kart and Track Randomizer
            </h1>
            <p>
      ...
      <main style={{ paddingTop: "3rem" }}>
        <Container>
          ...
          <section>
            <div className="kart-intro">
              <div className="kart-intro__content">
                ...
                <p>
                  You can add as many players or combos you like up to 24 total.
                </p>
          ...
          {/* Track Randomizer Section — only if cups data exists */}
          {hasCups && (
            <section>
              <div className="kart-intro">
                <div className="kart-intro__content">
