...
export function communityPresentation(kind: string, subtype: string | null): CommunityPresentation {
  if (kind !== "group") {
    return { icon: "", sectionOrder: ORDER_CHANNEL, feedHeading: "Community feed", feedEmpty: "No posts yet.", membersLabel: "Members", membersEmpty: "Be the first to join.", descriptor: "", joinLabel: "Join community", joinedLabel: "Joined ✓" };
  }
  switch (subtype) {
    case "family":
      return { icon: "👪", sectionOrder: ORDER_SOCIAL, feedHeading: "Family feed", feedEmpty: "No posts yet. Share what the family's playing.", membersLabel: "Family members", membersEmpty: "No family members yet.", descriptor: "A family game-night community", joinLabel: "Join the family", joinedLabel: "Joined ✓" };
    case "friends":
      return { icon: "🎲", sectionOrder: ORDER_SOCIAL, feedHeading: "Group feed", feedEmpty: "No posts yet. Kick off the group chat.", membersLabel: "Members", membersEmpty: "No one's joined yet.", descriptor: "A friend-group community", joinLabel: "Join the group", joinedLabel: "Joined ✓" };
    case "org":
      return { icon: "🏢", sectionOrder: ORDER_ORG, feedHeading: "Announcements", feedEmpty: "No announcements yet.", membersLabel: "Members", membersEmpty: "No members yet.", descriptor: "An organization community", joinLabel: "Join", joinedLabel: "Joined ✓" };
    case "event":
      return { icon: "🎉", sectionOrder: ORDER_EVENT, feedHeading: "Event updates", feedEmpty: "No updates yet. Post the details, schedule, or a welcome.", membersLabel: "Attendees", membersEmpty: "No one's RSVP'd yet. Be the first.", descriptor: "A game-night event", joinLabel: "RSVP", joinedLabel: "Going ✓" };
    default:
      return { icon: "👥", sectionOrder: ORDER_SOCIAL, feedHeading: "Community feed", feedEmpty: "No posts yet.", membersLabel: "Members", membersEmpty: "Be the first to join.", descriptor: "A community", joinLabel: "Join community", joinedLabel: "Joined ✓" };
  }
}
