...
export const MARKETING_APPS: Record<string, AppMarketingContent> = {
  ...
  "mario-kart-tournaments": {
    ...
    metaTitle: "Mario Kart Tournaments — Brackets & Live Scoring",
    metaDescription:
      "Create Mario Kart 8 Deluxe or Mario Kart World tournaments — single & double-elimination brackets, round-robin, and FFA points with live per-race scoring and standings. Seed players, add guests, and run it live. Free with an account.",
    breadcrumbLabel: "Mario Kart Tournaments",
    eyebrow: "Tournaments · Beta",
    status: "beta",
    h1: "Mario Kart Tournaments",
    heroSubhead:
      "Run Mario Kart tournaments your way — single or double-elimination brackets, round-robin, or FFA points, with live scoring and standings. Built for Mario Kart 8 Deluxe and Mario Kart World.",
    heroImage: "/images/fg/mario-holding-trophy.jpg",
    heroImageAlt: "Mario holding a trophy",
    toolHref: "/tournament",
    toolCtaLabel: "Browse & create tournaments",
    overview:
      "GameShuffle's tournament builder runs real competitions for Mario Kart 8 Deluxe and Mario Kart World. Pick a format — single or double-elimination brackets, round-robin, or FFA points — then set your tracks, item rules, and build restrictions (weight class, drift or vehicle type, and character ban/allow lists). Seed players by check-in order, standings, or at random, add guests who don't have an account, and run it live: per-race scoring feeds real-time standings, and brackets update on a shareable public page. Browsing and joining are open; creating is free with an account.",
    featuresHeading: "What you can do",
    features: [
      ...
      { icon: "bolt", title: "Four formats", description: "FFA points, round-robin, single elimination, and double elimination — Swiss on the way." },
      ...
      { icon: "users", title: "Guests & seeding", description: "Add players without an account and seed by check-in, standings, or random." },
      { icon: "activity", title: "Two games, live", description: "MK8DX and Mario Kart World — rosters, standings, and brackets update in real time." },
    ],
    howItWorksHeading: "How it works",
    howItWorks: [
      { title: "Create your tournament", description: "Pick your game and format, then set tracks, rules, and build restrictions." },
      { title: "Seed the field", description: "Players join with their profile and friend code, or add guests — then seed the bracket." },
      { title: "Run it live", description: "Score races or report match winners; standings and the bracket update in real time." },
    ],
    crossSell: PRO_CROSS_SELL,
    faqHeading: "Frequently asked questions",
    faq: [
      { q: "What tournament formats are supported?", a: "FFA points, round-robin, single-elimination, and double-elimination brackets, with Swiss on the way. (Double-elimination currently needs a power-of-2 player count.)" },
      ...
      { q: "How does scoring work?", a: "For points formats, enter each race's finishing order and GameShuffle tallies cumulative points into live standings. For brackets, report match winners and players advance automatically." },
      ...
      { q: "Do brackets and standings update live?", a: "Yes. Rosters, standings, and the bracket update in real time for players and viewers on a shareable public page." },
    ],
