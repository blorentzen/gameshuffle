...
export const MARKETING_APPS: Record<string, AppMarketingContent> = {
  ...
  "mario-kart-tournaments": {
    ...
    metaDescription:
      "Run Mario Kart 8 Deluxe or Mario Kart World tournaments — single & double-elim brackets, round-robin, FFA points, and the Heat → Mains ladder — or a full championship series where points carry across events into a season table. Live scoring, guests, shareable pages. Free with an account.",
    ...
    overview:
      "GameShuffle's tournament builder runs real competitions for Mario Kart 8 Deluxe and Mario Kart World. Choose a single tournament or a championship series: single tournaments pick any format — single or double-elimination brackets, round-robin, FFA points, or the new Heat → Mains ladder — while a championship series runs a season of Heat → Mains events where points accumulate into a live standings table. Set your tracks, item rules, and build restrictions (weight class, drift or vehicle type, and character ban/allow lists), seed players by check-in, standings, or at random, add guests who don't have an account, and run it live: per-race scoring feeds real-time standings, brackets and season tables update on a shareable public page. Browsing and joining are open; creating is free with an account.",
    featuresHeading: "What you can do",
    features: [
    ...
    howItWorks: [
      ...
      { title: "Run it live", description: "Score races, report winners, or call heats into the mains; standings, brackets, and the season table update in real time." },
    ],
    crossSell: PRO_CROSS_SELL,
    faqHeading: "Frequently asked questions",
    faq: [
