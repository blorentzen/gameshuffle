...
import { getCompanionTool } from "@/lib/board-game-nights/companion/tools";
import { RosterBar } from "@/components/board-game-nights/companion/RosterBar";
import { ToolExplainer } from "@/components/board-game-nights/companion/ToolExplainer";
      ...
      <section style={{ margin: "var(--spacing-32) 0 var(--spacing-64)" }}>
        <Breadcrumb
          items={[
            ...
            { label: "Tools", href: "/board-game-nights/tools" },
            { label: tool.name },
          ]}
        />
        <h1
