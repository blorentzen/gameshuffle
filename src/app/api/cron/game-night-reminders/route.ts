/**
 * GET /api/cron/game-night-reminders
 *
...
import { sendDueNightReminders } from "@/lib/game-nights/reminders";
...
export async function GET(request: Request) {
  ...
  if (cronSecret) {
    ...
    console.error("[cron/game-night-reminders] CRON_SECRET missing in production");
