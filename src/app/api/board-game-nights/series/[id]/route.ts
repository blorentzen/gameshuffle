/**
 * PATCH  /api/board-game-nights/series/[id]  { active }        → pause/resume
 * POST   /api/board-game-nights/series/[id]  { action:"generate" } → make the next instance now
 * DELETE /api/board-game-nights/series/[id]                    → delete the series
 *
...
import {
  ...
  getOwnSeries,
  materializeSeries,
} from "@/lib/board-game-nights/series";
