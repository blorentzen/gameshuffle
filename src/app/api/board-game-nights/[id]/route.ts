/**
 * PATCH  /api/board-game-nights/[id] → update a night (host only).
 * DELETE /api/board-game-nights/[id] → delete a night (host only).
...
import { getNight, updateNight, deleteNight } from "@/lib/board-game-nights/store";
