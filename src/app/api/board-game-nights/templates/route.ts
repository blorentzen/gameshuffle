/**
 * GET    /api/board-game-nights/templates            → the host's templates
 * POST   /api/board-game-nights/templates            → create a template
 *          body: { fromNightId, name? }  OR  { name, data }
 * DELETE /api/board-game-nights/templates?id=<id>    → delete one
 *
 * Templates are host-owned reusable night setups (RLS-scoped). See
 * `supabase/board-game-night-templates.sql`.
 */
...
} from "@/lib/board-game-nights/templates";
